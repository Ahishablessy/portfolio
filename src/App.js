  ...
  <div className="row px-lg-5 px-md-0 px-sm-0 px-0 mx-lg-5 mx-md-0 mx-sm-0 mx-0">
    ...
    <div className="col-lg-6 col-md-12 col-sm-12 col-12 d-flex justify-content-center align-items-center" style={{ textAlign: 'center' }}>
      <div className="slide-right">
        ...
        {/* <div id="about" className="scroll-content px-lg-5 px-md-5 px-sm-3 px-1 mx-lg-4 mx-md-1 mx-sm-0 mx-0" style={{ paddingTop: '60px' }}>
          <h3 style={{ textAlign: "center" }} className='my-lg-3 my-md-2 my-sm-2 my-2'><strong>About me</strong></h3>
          <div className='row'>
